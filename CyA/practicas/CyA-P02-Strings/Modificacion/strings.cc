...
// Modificacion, Las vocales no se contabilizan a la hora de calcular la longitud
void String::LengthWordModify(std::ofstream &fileout) {
  std::string aux = GetString();
  int count = 0;
