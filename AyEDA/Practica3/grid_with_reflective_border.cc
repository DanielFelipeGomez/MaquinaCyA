 ...
 * @param num_columns
 */
GridWithReflectiveBorder::GridWithReflectiveBorder(int num_rows, int num_columns) {
 ...
 * @return Cell&
 */
Cell& GridWithReflectiveBorder::GetCell(int axisX, int axisY) {
  if (axisX == 0) {
    axisX += 1;
  }
  if (axisY == 0) {
 ...
 * @return const Cell&
 */
const Cell& GridWithReflectiveBorder::GetCell(int axisX, int axisY) const {
  if (axisX == 0) {
    axisX += 1;
  }
  if (axisY == 0) {
