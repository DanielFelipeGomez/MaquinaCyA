 ...
 * @param num_columns
 */
GridWithOpenBorder::GridWithOpenBorder(int num_rows, int num_columns) {
 ...
 * @return Cell& 
 */
Cell& GridWithOpenBorder::GetCell(int axisX, int axisY) {
 ...
 * @return const Cell&
 */
const Cell& GridWithOpenBorder::GetCell(int axisX, int axisY) const {
  return array_pointer_[axisX][axisY];
}
